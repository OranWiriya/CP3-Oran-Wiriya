...
def WriteCSV():
    ...
    with open('employee_file.csv', mode='w') as employee_file:
        ...
        #ส่วนการเพิ่มข้อมูล
        employee_writer.writerow(['Oran Wiriya', 'Fullstack', 'December'])
        employee_writer.writerow(['Toy meyer', 'Architect', 'March'])
        employee_writer.writerow(['Four Pachomchon', 'Architect', 'June'])
